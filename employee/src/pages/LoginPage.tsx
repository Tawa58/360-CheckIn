...
import {AlertCircle, Eye, EyeOff, KeyRound, Loader2, Lock, UserRound} from 'lucide-react';
...
export function LoginPage() {
  ...
  useEffect(() => {
    document.title = 'Employee login · CheckIn360';
  }, []);
    ...
    <div className="relative min-h-dvh overflow-hidden bg-brand-900 px-5 dark:bg-slate-950">
      ...
      <div className="relative mx-auto flex min-h-dvh w-full max-w-md items-center justify-center py-28">
        <div className="w-full">
          <h1 className="sr-only">CheckIn360 employee check-in</h1>
          ...
          <p className="mt-6 text-center text-xs text-white/50">
            Check-in stays locked until this browser can verify a live GPS position.
          </p>
        </div>
      </div>
    </div>
